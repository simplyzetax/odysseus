/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9efa57ecb452a868ccb6166b5d4afd09)
...
declare namespace Cloudflare {
	interface Env {
		...
		EOS_PRODUCT_ID: string;
		EOS_SANDBOX_ID: string;
		EOS_DEPLOYMENT_ID: string;
		EOS_CLIENT_ID: string;
		EOS_CLIENT_SECRET: string;
		ENV: string;
		CACHE_DO: DurableObjectNamespace<import("./src/index").CacheDurableObject>;
		XmppServer: DurableObjectNamespace<import("./src/index").XMPPServer>;
		DATABASE_DO: DurableObjectNamespace<import("./src/index").DatabaseDurableObject>;
		R2: R2Bucket;
		MANIFESTIFY: Fetcher /* manifestify */;
		DB: Hyperdrive;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "JWT_SECRET" | "BASE_URL" | "DISABLE_CACHE" | "DEV_AUTH_TOKEN" | "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_CLIENT_SECRET" | "DISCORD_BOT_TOKEN" | "EOS_PRODUCT_ID" | "EOS_SANDBOX_ID" | "EOS_DEPLOYMENT_ID" | "EOS_CLIENT_ID" | "EOS_CLIENT_SECRET" | "ENV">> {}
}
