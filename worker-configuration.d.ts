/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 02cd2b7aef44a11cef935fd94eb77a89)
// Runtime types generated with workerd@1.20250617.0 2025-06-20 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		kv: KVNamespace;
		CACHE_DO: DurableObjectNamespace /* CacheDurableObject from odysseues */;
		r2: R2Bucket;
		DB: Hyperdrive;
	}
}
